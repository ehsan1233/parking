...
export function RegisterRoutes(app: Router) {
  ...
  app.post(
    ...
    async function ParkingSpotController_reportFreeSpot(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsParkingSpotController_reportFreeSpot,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ParkingSpotController_getNearbySpots(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsParkingSpotController_getNearbySpots,
          request,
          response,
        });
  ...
  app.patch(
    ...
    async function ParkingSpotController_takeSpot(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsParkingSpotController_takeSpot,
          request,
          response,
        });
